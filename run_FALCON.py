...
from falcon_engine.utilities import extract_training_data, init_pipeline, save_pipeline
...
def main():
  ...
  for c in cell_type_list:   #Loop through model training for each cell type of interest
    ...
    #save_pipeline(pipeline=pipeline_dict, path = pipeline_path, step= 'LEARNING CURVE')
